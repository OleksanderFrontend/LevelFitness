...
const cards = (parentSelector) => {
  ...
  (0,_services__WEBPACK_IMPORTED_MODULE_0__["default"])('http://localhost:3000/trainings')
    .then(data =>{
...
const slider = () => {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#menu, .menu__list").on("click", "a", function (event) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.hero__slider').slick({
      responsive: [{
        breakpoint: 768,
        settings: {
          arrows: false,
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__button, .menu').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__button').toggleClass('active');
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  ;(0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])('.programs__cards');
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.header__btn', '.modal', '.modal__close');
